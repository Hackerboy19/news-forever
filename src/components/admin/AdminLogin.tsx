...
import { Lock, Newspaper, LogIn } from 'lucide-react';
    ...
    <div className="min-h-screen bg-stone-950 flex items-center justify-center p-4">
      <div className="w-full max-w-sm bg-white border border-stone-200 shadow-2xl">
        <div className="p-6 border-b border-stone-200 bg-[#FAF8F5] text-center space-y-2">
          <div className="w-12 h-12 mx-auto rounded-xl bg-gradient-to-br from-[#991B1B] to-stone-900 text-white flex items-center justify-center">
            <Newspaper className="w-6 h-6 text-amber-100" />
          </div>
